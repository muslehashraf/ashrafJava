...
public class CurrentDate {
    public static void main(String[] args) {
        ...
        System.out.println(localTime); // 11:18:56.475  hh:mm:ss.SSS
        System.out.println(localTime.minus(2, ChronoUnit.HOURS)); // 09:30:53.016

        System.out.println("\n----------LocalDateTime class----------\n");
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println(localDateTime); // 2022-12-11T11:22:28.142  yyyy-MM-ddThh:mm:ss.SSS
    }
}
