...
public class Homework04 {
    public static void main(String[] args) {
       ...
       String address = ScannerHelper.getAnAddress();
        ...
        String lFavColors = favColors.toLowerCase();
        if(lFavColors.contains("red") && lFavColors.contains("green"))System.out.println("Green and red are in the list");
            else if (lFavColors.contains("red")) System.out.println("Red is in the list");
            else if (lFavColors.contains("green")) System.out.println("Green is in the list");
